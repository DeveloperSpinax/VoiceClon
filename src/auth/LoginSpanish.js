...
function CopyrightSpanish(props) {
    return (
        ...
        <ThemeProvider theme={defaultTheme} >
            <Container component="main" maxWidth="xs" >
                    ...
                    >
                        ...
                        >
                            ¡Bienvenido de nuevo! Es bueno ver que escuchas😃
                        </Typography>
                        ...
                        >
                            {/* Username */}
                            <Typography align="left" variant='body2' sx={{ fontFamily: 'Nunito Sans', letterSpacing: '0.5px' }}>Nombre de usuario o correo electrónico</Typography>
                            <TextField
                                margin="normal"
                                required
                                fullWidth
                            ...
                            <Grid container>
                                <Grid item xs={6}>
                                    <Typography align="left" variant='body2' sx={{ mt: 0.5, fontFamily: 'Nunito Sans' }}>Contraseña</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                    <Typography align="right" variant='body2' sx={{ color: '#3b99ed', mt: 0.5, fontFamily: 'Catamaran' }}>¿Olvidó la contraseña?</Typography>
                                </Grid>
                            </Grid>
