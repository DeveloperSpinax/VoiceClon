        ...
        <ThemeProvider theme={defaultTheme}>
            ...
            >
                ...
                >
                    ...
                    >
                        {/* Username */}
                        <Typography align="left" variant='body2' sx={{ fontFamily: 'Nunito Sans', letterSpacing: '0.5px' }}>Username</Typography>
                        <TextField
                            margin="normal"
                            required
                            fullWidth
                        ...
                        {/* Email */}
                        <Typography align="left" variant='body2' sx={{ fontFamily: 'Nunito Sans', letterSpacing: '0.5px' }}>Email</Typography>
                        <TextField
                            margin="normal"
                            required
                            fullWidth
                        ...
                        <Grid container spacing={.5} sx={{ mt: -2.5 }}>
                            <Grid item xs={12}>
                                <Typography align="left" variant='body2' sx={{ mt: 2, fontFamily: 'Nunito Sans' }}>Password</Typography>
                            </Grid>
                        </Grid>
